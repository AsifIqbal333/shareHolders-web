<x-website-layout>
    ...
    <section class="relative table w-full py-32 lg:py-36 bg-no-repeat bg-center bg-cover"
        ...
        <div class="container">
            <div class="grid grid-cols-1 text-center mt-10">
                ...
                <div class="mt-4">
                    <button data-modal-target="selling-modal" data-modal-toggle="selling-modal"
                        class="btn bg-green-600 hover:bg-green-700 text-white rounded-md mt-3">{{ __('Sell with Us') }}</button>
                </div>
            </div><!--end grid-->
        </div><!--end container-->
    </section><!--end section-->
    ...
    <!-- Main modal -->
    <div id="selling-modal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                        {{ __('Sell your property to Shareholders') }}
                    </h3>
                    <button type="button"
                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                        data-modal-hide="selling-modal">
    ...
    @if (session('success'))
        <div id="toast-success"
            class="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 fixed top-20 right-5"
            role="alert">
            <div
