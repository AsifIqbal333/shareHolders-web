            ...
            <div
                ...
                <div class="flex justify-between items-center px-8 py-4">
                    ...
                    <div class="flex flex-col gap-3">
                        {{-- {{ !$wallet->completed_stripe_onboarding ? 'disabled' : '' }} --}}
                        <button type="button" data-modal-target="deposit-modal" data-modal-toggle="deposit-modal"
                            class="text-white bg-gray-700 hover:bg-gray-800 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-md px-5 py-1.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700 disabled:cursor-not-allowed disabled:opacity-60">{{ __('Deposit') }}</button>
