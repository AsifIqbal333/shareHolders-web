<div class="container lg:mt-24 mt-16">
    <div class="grid grid-cols-1 pb-8 text-center">
        ...
        <p class="text-slate-400 max-w-xl mx-auto">A great plateform to buy, sell and rent your properties without any
    ...
    <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
        ...
        <div
            ...
            <div class="mt-6">
                ...
                <p class="text-slate-400 mt-3">If the distribution of letters and 'words' is random, the reader will not
